...
class DealService
{
    ...
    public function getDeal($dealId): Deal
    {
        ...
        $responseArray = $this->queryHelper->getQueryBatch(CRestTula::class, [
            'deal' => [
                'method' => 'crm.deal.get',
                'params' => [
                    'ID' => $dealId
    ...
    {
        $ufaAdd = $this->queryHelper->getQueryBatch(CRestUfa::class, [
            'contact' => [
    ...
    public function updateDeal($sqlDealId, $stage)
    {
        ...
        return $this->queryHelper->getQuery(CRestUfa::class, 'crm.deal.update',[
            'ID' => $sqlDealId,
            'fields' => [
                'STAGE_ID' => $stage,
            ],]);
